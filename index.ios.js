              ...
              items: [
                  {
                      ...
                      renderedContent: this._renderContent('red', 'oo', 23)
                  },
                  {
                      title: '他的',
                      selected: false,
                  ...
                  {
                      title: '我的',
                      icon:require('./app/component/flux.png'),
                      selectedIcon:require('./app/component/relay.png'),
                      selected: false,
...
//
// var _renderContent = function(color: string, pageText: string, num?: number) {
//     return (
//       <View style={[styles.tabContent, {backgroundColor: color}]}>
